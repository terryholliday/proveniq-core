-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'AUDITOR', 'INVESTOR');

-- CreateEnum
CREATE TYPE "OrgRole" AS ENUM ('OWNER', 'ADMIN', 'MEMBER', 'VIEWER');

-- CreateEnum
CREATE TYPE "AssetStatus" AS ENUM ('PENDING', 'VERIFIED', 'FLAGGED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "VerificationType" AS ENUM ('OWNERSHIP', 'CONDITION', 'LOCATION', 'EXISTENCE');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INFO', 'SUCCESS', 'WARNING', 'ERROR', 'VERIFICATION', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "verifications_assetId_requestedAt_idx" ON "verifications"("assetId", "requestedAt");
...
-- AddForeignKey
ALTER TABLE "verifications" ADD CONSTRAINT "verifications_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "assets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
